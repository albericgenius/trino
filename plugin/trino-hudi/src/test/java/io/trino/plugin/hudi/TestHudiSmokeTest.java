        ...
        extends AbstractTestQueryFramework
{
    ...
    @DataProvider(name = "incrementalQueryProvider")
    public Object[][] incrementalQueryProvider()
    {
        return new Object[][] {
                ...
                {"SELECT count(_hoodie_commit_time) FROM STOCK_TICKS_COW FOR VERSION AS OF 20211216099999999", "VALUES 0"},
                {"SELECT count(1) FROM STOCK_TICKS_COW FOR VERSION AS OF 20211216099999999", "VALUES 0"},
                {"SELECT count(*) FROM STOCK_TICKS_COW FOR VERSION AS OF 20211216099999999", "VALUES 0"},
                {"SELECT count(_hoodie_commit_time) FROM STOCK_TICKS_COW FOR TIMESTAMP AS OF TIMESTAMP '2021-12-21 16:07:14.537470000 Z'", "VALUES 99"},
                {"SELECT count(1) FROM STOCK_TICKS_COW FOR TIMESTAMP AS OF TIMESTAMP '2021-12-21 16:07:14.537470000 Z'", "VALUES 99"},
                {"SELECT count(*) FROM STOCK_TICKS_COW FOR TIMESTAMP AS OF TIMESTAMP '2021-12-21 16:07:14.537470000 Z'", "VALUES 99"},
    ...
    @Test(dataProvider = "incrementalQueryProvider")
    public void testIncrementalQuery(@Language("SQL") String sql, String expected)
    {
